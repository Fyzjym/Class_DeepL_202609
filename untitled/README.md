...
{% hint style="warning" %}
`nvidia-smi` 中显示的 **CUDA Version** 表示当前 NVIDIA Driver 能支持的最高 CUDA 版本之一， 它不等于你安装的 PyTorch CUDA Runtime，也不等于 `nvcc --version`。
{% endhint %}
...
{% tab title="NVIDIA CUDA 13.0" %}
```powershell
python -m pip install torch==2.14.0 torchvision==0.29.0 --index-url https://download.pytorch.org/whl/cu130
```
{% endtab %}

{% tab title="NVIDIA CUDA 12.6" %}
```powershell
python -m pip install torch==2.14.0 torchvision==0.29.0 --index-url https://download.pytorch.org/whl/cu126
```
{% endtab %}
...
{% hint style="info" %}
如果系统默认 Python 不是 3.11，可以使用 Conda / Miniconda 建立 Python 3.11 环境， 不建议为了课程实验强行替换 Linux 系统自带 Python。
{% endhint %}
{% endstep %}
...
{% tabs %}
{% tab title="Windows + Anaconda + NVIDIA GPU" %}
```bash
conda create -n pytorch python=3.11 -y
conda activate pytorch
...
{% tab title="Windows + Anaconda + CPU" %}
```bash
conda create -n pytorch python=3.11 -y
conda activate pytorch
...
{% tab title="Windows Terminal + venv + NVIDIA GPU" %}
```powershell
py -3.11 -m venv .venv
.\.venv\Scripts\Activate.ps1
...
* 官方主页：[https://pytorch.org/](https://pytorch.org/)
* 安装页面：[https://pytorch.org/get-started/locally/](https://pytorch.org/get-started/locally/)
* 官方文档：[https://docs.pytorch.org/docs/stable/](https://docs.pytorch.org/docs/stable/)
* 官方 Tutorials：[https://docs.pytorch.org/tutorials/](https://docs.pytorch.org/tutorials/)
* 历史版本安装：[https://pytorch.org/get-started/previous-versions/](https://pytorch.org/get-started/previous-versions/)

### Python / Conda

* Python：[https://www.python.org/](https://www.python.org/)
* Miniconda：[https://docs.conda.io/projects/miniconda/](https://docs.conda.io/projects/miniconda/)
* Anaconda：[https://www.anaconda.com/](https://www.anaconda.com/)

### NVIDIA

* NVIDIA Driver：[https://www.nvidia.com/Download/index.aspx](https://www.nvidia.com/Download/index.aspx)
* CUDA Compatibility：[https://docs.nvidia.com/deploy/cuda-compatibility/](https://docs.nvidia.com/deploy/cuda-compatibility/)

### 国内镜像

* 清华 TUNA：[https://mirrors.tuna.tsinghua.edu.cn/](https://mirrors.tuna.tsinghua.edu.cn/)
* PyPI 镜像帮助：[https://mirrors.tuna.tsinghua.edu.cn/help/pypi/](https://mirrors.tuna.tsinghua.edu.cn/help/pypi/)
* Anaconda 镜像帮助：[https://mirrors.tuna.tsinghua.edu.cn/help/anaconda/](https://mirrors.tuna.tsinghua.edu.cn/help/anaconda/)
